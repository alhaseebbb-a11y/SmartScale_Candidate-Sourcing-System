...
- **Frontend (Vercel):** [https://your-frontend.vercel.app](https://your-frontend.vercel.app) *(To be updated after deployment)*
- **Backend API (Render):** [https://your-backend.onrender.com](https://your-backend.onrender.com) *(To be updated after deployment)*
- **Interactive API Docs (Swagger):** [https://your-backend.onrender.com/docs](https://your-backend.onrender.com/docs)
